...
function compile(file, output, libraries, cb) {
  switch (file.split('.').pop()) {
    case 'S':
      _compile('avr-gcc', file, output, libraries, sArgs, cb); break;
    case 'c':
      _compile('avr-gcc', file, output, libraries, cArgs, cb); break;
    case 'cpp':
      _compile('avr-g++', file, output, libraries, cppArgs, cb); break;
    case 'h':
      cb('Skipping ' + file);
      break;
    default:
