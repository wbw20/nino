...
module.exports = {
  ...
  execute: function(options) {
    async.series([
      ...
      function(cb) {
        recursiveCompile(environment.install() + 'headers/arduino', ['arduino/pins/standard/', 'arduino/'], function(error, stdout, stderr) {
          cb(error, 'Building core');
        });
      },
      function(cb) {
